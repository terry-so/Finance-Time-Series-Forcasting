...
# Moving Average
parser.add_argument('--ma_type', type=str,
                    default='ema', help='reg, ema, dema')
...
parser.add_argument('--directional_alpha', type=float, default=0.5,
                    help='weight for base loss in directional loss')
parser.add_argument('--directional_beta', type=float,
                    default=1.0, help='weight for directional loss')
parser.add_argument('--directional_gamma', type=float, default=0.1,
                    help='weight for magnitude penalty in weighted directional loss')
